...
public class ItemController {
    ...
    private TaotaoResult addPic(MultipartFile file){
        TaotaoResult result = tbItemService.addPic(file);
        return result;
    }
    @RequestMapping("/addPicDes")
    private LayuiEditResult addPicDes(MultipartFile file){
        LayuiEditResult result = tbItemService.addPicDes(file);
        return result;
    }
